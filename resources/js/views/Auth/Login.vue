                ...
                <div class="w-100 mx-5">
                    ...
                    <v-form ref="form" lazy-validation>
                        ...
                        <div class="d-flex justify-end">
                            <router-link
                                :to="{ name: 'reset-email-password' }"
                                class="grey--text bod-2"
                    ...
                    <div
                        class="d-flex flex-column mt-9 gray--text text-center justify-center body-2"
                    >
                        <span class="my-2"
                            >ورود با اکانت
                            <router-link
                        ...
                        >
                        <span class="my-2"
                            >ثبت نام به منزله موافقت با قوانین است</span
                        >
                        <router-link class="my-2" :to="{ name: 'register' }"
                            >رفتن به صفحه ثبت نام</router-link
                        >
                    </div>
                </div>
            </v-col>
