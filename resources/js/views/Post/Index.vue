            ...
            <v-col cols="12" md="8">
                <v-list-item>
                    ...
                    <v-list-item-content>
                        <v-list-item-title>
                            ...
                            <v-btn class="mr-4" :color="post.user.is_follow ? 'info' : 'grey'" rounded dark small @click="followUser" v-if="$store.state.user.isLoggedIn && post.user.id != $store.state.user.user.id">
                ...
                <div class="mb-4">
                    ...
                    <div class="post-module_tags mt-4">
                        <v-chip class="ml-2" :ripple="false" v-for="category in post.categories" :key="category.title">
                            {{ category.title }}
                        </v-chip>
                    </div>
                    ...
                    <div class="d-flex flex-row mt-9">
                        ...
                        <v-btn outlined rounded color="blue-grey" class="ma-2 white--text" v-clipboard:copy="short_link">
                            {{ short_link }}
                            <v-icon right dark>
                                mdi-content-copy
                            </v-icon>
                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12" md="4" v-for="(related_post,index) in related_posts" :key="index">
                                ...
                                <v-card>
                                    <v-img height="160" max-height="160" :src="related_post.banner_src">
                                    </v-img>
                                    ...
                                    <v-card-actions>
                                        <div class="d-flex flex-row">
                                            <v-avatar size="45">
                                                <v-img :src="related_post.user.profile_src"></v-img>
                                            </v-avatar>
                                            <div class="mr-2">
                                                <router-link :to="{name : 'user-posts',params : {username : related_post.user.username}}">
                ...
                <div class="mt-12">
                    ...
                    <post-comments v-for="(comment,index) in post.parent_comments" :key="index" :data="comment"></post-comments>
                </div>
            </v-col>
        </v-row>
    </v-container>
