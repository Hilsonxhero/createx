<template>
    <div class="d-flex mb-10" v-if="post.user" >
        <div class="w-100">
            <h3 v-html="post.title"></h3>
            <p class="body-2 grey--text my-4" v-html="post.dec">
            ...
            <div class="d-flex flex-row align-center">
                <div>
                    <v-list-item>
                        ...
                        <v-list-item-content>
                            <div class="body-2 dark--text font-weight-bold">{{ post.user.name }}</div>
                            <div class="caption grey--text">{{ post.created_at }}</div>
                        </v-list-item-content>
                    </v-list-item>
                </div>
                <v-spacer></v-spacer>
